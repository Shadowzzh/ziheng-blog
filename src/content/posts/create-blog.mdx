---
title: '使用 Nextjs+Tailwind+Contentlayer 搭建博客'
date: 2024-06-11
description: '🎉 🎉 快速创建个人博客，支持 mdx 编写、服务端渲染、Github 评论、主题切换等功能'
---
...
[Nextjs][Nextjs] 是一个是一个基于 React 的服务端渲染框架。
[Tailwind][Tailwind]无需书写 CSS，即可快速构建美观的网站的组件库。.
[Contentlayer][Contentlayer]将内容转换成 JSON 并导入应用程序。.
...
使用[Contentlayer][Contentlayer]来解析 mdx 文件，新建`contentlayer.config.ts`文件
...
- [@tailwindcss/typography](https://github.com/tailwindcss/typography): tailwind 风格的 HTML 排版
- [reading-time](https://github.com/ngryman/reading-time): 解析文档内容字符数量，并计算预计阅读时间
- [remark-gfm](https://github.com/remarkjs/remark-gfm): mdx 转成 html 插件
- [rehype-slug](https://github.com/rehypejs/rehype-slug): h1-h6 标签添加 id
